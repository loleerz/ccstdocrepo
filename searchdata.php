<?php
    ...
    if(isset($_POST['input']))
    {
        ...
        $sql = "SELECT * FROM student_info WHERE Lname LIKE ? OR Fname LIKE ? OR Mname LIKE ?";
        ...
        $stmt->bind_param("sss", $searchParam, $searchParam, $searchParam); // Assuming all columns are strings, adjust "sss" accordingly
