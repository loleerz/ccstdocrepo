  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#addSection">Add Section</button>
          ...
          <div class="modal-dialog modal-lg modal-dialog-scrollable">
                              ...
                              <form action="input.php" method="post">
                                  ...
                                  <div class="row g-3">
                                      <div class="col-md-4">
                                          ...
                                          <input type="text" name="sectionname" class="form-control" id="sectionname" placeholder="Enter section name" required>
                                      </div>
                                  </div>

                                  <div class="row">
                                      <div class="col-6 mt-3 mb-3">
                                          <span class="fs-5 fw-semibold">Section Details</span>
                                      </div>
                                  </div>
                                  ...
                                  <div class="row mt-3 mb-3">
                                    <div class="col-md-9">
                                      <div class="card card-primary collapsed-card">
                                        <div class="card-header">
                                          <h3 class="card-title fw-semibold">Strand</h3>
                                                                      ...
                                                                      <div class='input-group'>
                                                                          <div class='input-group-prepend'>
                                                                              <span class='input-group-text'>
                                                                                  <input type='radio' name='strand' id='".$row['strand_name']."' value = '".$row['strand_name']."'>
                                                                              </span>
                                                                          </div>
                                  ...
                                  <div class="row">
                                      <div class="col-md-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="adviser" id="adviser" class="form-select" required>
            ...
            <!-- MODAL CONTENT -->
              <div class="modal-footer">
                ...
                <input type="submit" class="btn btn-info btn-lg" id="addsection" name="addsection" value="Add Record">
              </div>
            </form>
            </div>
          </div>
        ...
        <table id="example2" class="table table-bordered table-hover table-striped">
            ...
            <tbody id="tbody">
              ...
              $sql6 = "SELECT (@row_number := @row_number + 1) AS row_number, section.* 
              FROM section 
              ...
              $result5 = $stmt5->get_result();
                  ...
                  { 
                    ...
                    $stmt->bind_param("s", $row1['adviser']);
                    $stmt->execute();
                    $result = $stmt->get_result();
...
<script>
        $(document).ready(function() 
        {
            ...
            $("#search").keyup(function() {
                ...
                fetchStudents("search/searchSection.php", {input: input, schoolYear: schoolYear});
            });

            $("#school_years").change(function() {
                var schoolYear = $(this).val();
                console.log("School year changed to: " + schoolYear);
                fetchStudents("search/searchBSYSection.php", {schoolYear: schoolYear});
            });
            $("#strand").change(function() {
                var strand = $(this).val();
                var schoolYear = $("#school_years").val();
                console.log("Strand changed to: " + strand);
                fetchStudents("search/searchBStrandSection.php", {strand: strand, schoolYear: schoolYear});
            });
        });
