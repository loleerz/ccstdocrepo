...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- FORM137 TEMPLATE -->
    <iframe src="form137.php" id="f137F" frameborder="0" style="height:0; border:0;"></iframe>
    <!-- FORM137 TEMPLATE -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="generateForm137.php" class="nav-link active">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 fw-bold fs-4">Form 137 Generationz</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="card col-10">
            ...
            <div class="card-body p-0">
                <table id="example2" class="table table-bordered table-hover table-striped">
                    ...
                    <tbody id="tbody">
                        <?php
                        // Loop through the $result to display student information
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-success generate-btn" id="generate" data-student-no="<?= $row['student_no'] ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Generate</button>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title fs-4" id="previewModalLabel">Form 137 Preview</h6>
...
$(document).on('click', '.generate-btn', function() {
    ...
    $('#f137F').attr('src', 'f137info.php?student_no=' + studentNo);
