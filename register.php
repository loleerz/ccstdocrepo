                ...
                <div class="input-box">
                    ...
                    <form action="" method="post">
                        <div class="input-field">
                            <input type="text" class="input" name="employee_no" id="employee_no" required autocomplete="off">
                        ...
                        <div class="input-field">
                            <input type="text" class="input" name="mname" id="mname" required autocomplete="off">
                        ...
                        <div class="input-field">
                            <input type="text" class="input" name="suffix" id="suffix" required autocomplete="off">
                            <label for="suffix">Suffix</label> 
                        </div> 
                        <div class="input-field">
                            <input type="submit" class="submit" name="register" value="Register">
                            <figcaption class="text-center">Already have an account? <a href="index.php">Sign in here!</a></figcaption>
                        </div>
                    </form>
                </div>  
    </div>
